...
<body>
    <div class="menu">
      <img src="../image/logo.PNG" height="150px" width="100%">
        ...
        <a class="active" href="Contact.php"><i class="fa fa-envelope"></i> Messages </a>
        <a href="Report.php"><i class="fa fa-wallet"></i> Collection </a>   
      </div>

    <div class="fixedmenu">
    <div class="header">Messages <i class="fa fa-envelope"></i></div> 
          ...
          <table border="2px">
            ...
            <tbody>
              ...
              <?php
                ...
                <td><a href="deleteMessage.php?id=<?php echo $row["Contact_Id"]; ?>"><i class="fa fa-trash"></i></a></td>
                    </tr>
                    <?php $count++;?>
                    <?php
                    }
