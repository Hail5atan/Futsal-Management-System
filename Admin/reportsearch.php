...
<body>
  ...
  <form class="form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
      ...
      <div class="dropdown1"><?php $date=$_REQUEST['date']; ?>
          <span class="dropbtn1"><a class="active" href="reportsearch.php?date=<?php echo $date; ?>#all">All Courts
          <i class="fa fa-caret-down"></i></a>
        </span>
    <div class="dropdown-content1">
      <a href="reportsearch.php?date=<?php echo $date; ?>#ktm">Kathmandu</a>
      <a href="reportsearch.php?date=<?php echo $date; ?>#bkt">Bhaktapur</a>
      <a href="reportsearch.php?date=<?php echo $date; ?>#llt">Lalitpur</a>
    </div>  </div> </div> 
  ...
  <h1 style="text-decoration: underline;"> Daily</h1> 
          ...
          <table border="2px" style="font-size:20px;">
            ...
            <?php
                  ...
                  // create a query
                  $sql="SELECT Day, SUM(Amount) As Total FROM Book WHERE Status != 'Pending' AND Day='$date'";
                  //execute query
                  $result=mysqli_query($conn,$sql);
                  if($result){                 
                  while($row=mysqli_fetch_assoc($result)){?>
                 <tr>
                <td><?php echo date('jS \of F Y',strtotime($date)); ?></td>
          ...
          <table border="2px" style="font-size:20px;">
            ...
            <?php
                  include_once("config.php");
                    date_default_timezone_set("Asia/Kathmandu");
      				$date=$_REQUEST['date'];
                      $lastDay = strtotime("Saturday",strtotime($date));
                      $firstDay = strtotime("-6 days",$lastDay);
  ...
  <h1 style="text-decoration: underline;"> Daily</h1> 
          ...
          <table border="2px" style="font-size:20px;">
            ...
            <?php
                  ...
                  // create a query
                  $sql="SELECT Day, SUM(Amount) As Total FROM Book WHERE Status != 'Pending' AND Location='Kathmandu' AND Day='$date'";
                  //execute query
                  $result=mysqli_query($conn,$sql);
                  if($result){                 
                  while($row=mysqli_fetch_assoc($result)){?>
  ...
  <h1 style="text-decoration: underline;"> Daily</h1> 
          ...
          <table border="2px" style="font-size:20px;">
            ...
            <?php
                  ...
                  // create a query
                  $sql="SELECT Day, SUM(Amount) As Total FROM Book WHERE Status != 'Pending' AND Location='Bhaktapur' AND Day='$date'";
                  //execute query
                  $result=mysqli_query($conn,$sql);
                  if($result){                 
                  while($row=mysqli_fetch_assoc($result)){?>
  ...
  <h1 style="text-decoration: underline;"> Daily</h1> 
          ...
          <table border="2px" style="font-size:20px;">
            ...
            <?php
                  ...
                  // create a query
                  $sql="SELECT Day, SUM(Amount) As Total FROM Book WHERE Status != 'Pending' AND Location='Lalitpur' AND Day='$date'";
                  //execute query
                  $result=mysqli_query($conn,$sql);
                  if($result){                 
                  while($row=mysqli_fetch_assoc($result)){?>
